...
Added audio recordings management page for organizations, updated for gainforest-sdk 0.1.1
...
- **URL state management**: View mode, search, and edit state persist in URL for shareable links

### Audio Playback
- **Desktop**: Native HTML5 audio player with browser controls
- **Mobile**: Custom circular progress player with play/pause controls
- Display recording metadata (sample rate, recorded date, coordinates)

### Management
- **Create**: Upload new audio recordings (supports WAV, MP3, M4A, AAC, FLAC, OGG, Opus, WebM, AIFF up to 100MB)
- **Edit**: Update name (required), description, recorded date, coordinates, or replace audio file
