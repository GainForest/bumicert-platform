...
import { EcocertArt } from "./[draftId]/_components/Steps/Step4/EcocertPreviewCard";
      ...
      <div className="w-full flex items-start gap-6">
        <div className="flex-1 flex flex-col gap-4">
          ...
          <section className="flex flex-col p-4 rounded-xl gap-1 bg-background border border-border shadow-xl">
            ...
            <p>
              Start a new application to create an ecocert for the organization,
              and showcase your commitment to sustainability.
            </p>
            <div className="flex items-center justify-end mt-3">
              <Link href={links.ecocert.createWithDraftId("0")}>
                <Button>
                  Get Started
                  <ArrowRight />
                </Button>
...
export default CreateEcocertPage;
