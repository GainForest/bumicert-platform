      ...
      <div className="grid grid-cols-2 gap-4 rounded-3xl bg-foreground/2">
        <div className="h-full w-full flex items-center justify-center bg-foreground/2 p-4 rounded-3xl">
          <EcocertArt
            ...
            coverImage={"/assets/media/images/hero-ecocert-card/image0.png"}
            title={"An Awesome Ecocert"}
            objectives={[
        ...
        <div className="p-4 rounded-3xl">
          <Accordion type="single" defaultValue="item-1" collapsible>
            <AccordionItem value="item-1">
              ...
              <AccordionContent>
                An Ecocert is a certificate that records the creation of a
            ...
            <AccordionItem value="item-3">
              ...
              <AccordionContent>
                An Ecocert creates a direct pathway for supporters to fund
            ...
            <AccordionItem value="item-4">
              ...
              <AccordionContent>
                Each Ecocert stores when a restoration activity
            ...
            <AccordionItem value="item-5">
              ...
              <AccordionContent>
                ...
                by the Ecocert, allowing them to show their personal or
