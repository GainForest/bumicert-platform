...
export interface ProgressiveBlurProps {
  className?: string;
  /**
   * Border radius might be tricky and introduce some artifacts,
   * so use this prop to add a border radius to the blur. The effect
   * would be applied to all the blur layers.
   */
