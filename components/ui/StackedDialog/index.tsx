...
export const DialogContent = ({
  ...
  return (
    <div
      className={cn(
        "m-auto w-full min-w-md bg-background rounded-xl p-6 shadow-lg border border-border",
        className
      )}
    >
...
const StackedDialog: React.FC<StackedDialogProps> = ({
  ...
  const getContentAnimation = (indexFromLast: number) => ({
    initial: { scale: 1.1, filter: "blur(2px)", opacity: 0, y: 0 },
    animate: {
